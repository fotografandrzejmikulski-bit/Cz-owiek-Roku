...
class McpServer:
    ...
    Ekspozycja:
      Tools:
        - list_agents       : lista agentów z rejestru 55 555
    ...
    def _register_defaults(self) -> None:
        ...
        self._tools = [
            McpTool(
                name="list_agents",
                description="Zwraca stronicowaną listę agentów z rejestru 55 555.",
                input_schema={
                    "type": "object",
                    "properties": {
        ...
        self._resources = [
            McpResource(
                ...
                name="Agent Registry",
                description="Pełny rejestr 55 555 unikalnych agentów.",
            ),
            McpResource(
