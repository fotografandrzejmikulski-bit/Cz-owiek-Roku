...
# ===========================================================================
# Router: Agent Registry (55 555 unikalnych agentów)
# ===========================================================================

class RegistrySessionRequest(BaseModel):
    """Żądanie sesji z agentem z rejestru 55 555."""
...
async def list_registry_agents(
    ...
    """
    Zwraca stronicowaną listę agentów z rejestru 55 555.
...
async def registry_session(
    ...
    """
    Uruchamia sesję z wybranym agentem z rejestru 55 555.
    """
